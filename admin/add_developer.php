<?php
    ...
    if (isset($_POST['developer_id'])) {
        ...
        $sql_insert = "INSERT INTO developers (developer_id, developer_name, developer_country) VALUES ('$developer_id', '$developer_name', '$developer_country')";
...
<main>
    ...
    if (isset($_POST['developer_id'])) {
        if($result) {
            ...
            <a class="btn btn-primary px-5 mb-5" href="developers.php" role="button">
            Вернуться к таблице
            </a>';
        }
        else {
        ...
        <div class="d-flex flex-column mb-3 align-items-center">
            ...
            <div class="row g-3">
            <div class="col-sm-6">
            <label for="developer_id" class="form-label">ID разработчика</label>
            <input type="number" class="form-control" id="developer_id" name="developer_id">
            </div>
            ...
            <input type="text" class="form-control" id="developer_country" name="developer_country">
            </div>
            </div>
